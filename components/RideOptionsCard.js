  ...
  return (
    <SafeAreaView style={tw`bg-white flex-grow`}>
      <View>
        ...
        <Text style={tw`text-center bottom-6 text-xl`}>
      ...
      />
      <View style={tw`bottom-4 mt-auto border-t border-gray-200`}>
        <TouchableOpacity
          disabled={!selected}
          style={tw`bg-black  m-1 rounded-full ${!selected && "bg-gray-300"}`}
        >
